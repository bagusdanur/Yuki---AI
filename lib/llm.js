...
const PROVIDERS = {
  nineRouter: {
    ...
    client: new OpenAI({ apiKey: process.env.NINEROUTER_API_KEY || 'local-proxy', baseURL: process.env.NINEROUTER_BASE_URL || 'http://127.0.0.1:20128/v1', timeout: 18_000, maxRetries: 0 }),
    model: process.env.NINEROUTER_MODEL || 'ag/gemini-3-flash'
  },
  nineRouterPro: {
    name: '9Router (Gemini Pro)',
    client: new OpenAI({ apiKey: process.env.NINEROUTER_API_KEY || 'local-proxy', baseURL: process.env.NINEROUTER_BASE_URL || 'http://127.0.0.1:20128/v1', timeout: 25_000, maxRetries: 0 }),
  ...
  agentRouter: {
    name: 'AgentRouter',
    client: new OpenAI({ apiKey: process.env.AGENTROUTER_API_KEY || 'local-proxy', baseURL: process.env.AGENTROUTER_BASE_URL || 'http://127.0.0.1:18199/v1', timeout: 25_000, maxRetries: 0 }),
