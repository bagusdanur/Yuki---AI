...
export class Emotion {
  ...
  react(text = '') {
    ...
    if (/(sayang|cinta|kangen|rindu|kgn|peluk|suka sama kamu|suka kamu|naksir|taksir|gombal|demen|love you|iloveyou|mwah|hug|sayangku|pacar|pacaran)/.test(t)) {
      if (close < 0.12) {
    ...
    // --- Negatif ---
    if (/(benci|bodoh|bego|nyebelin|menyebalkan|jelek banget|diam kamu|pergi sana|berisik|jelek|goblok|tolol|annoying|bodo|bacot)/.test(t)) {
